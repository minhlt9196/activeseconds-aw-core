...
def flood(events: List[Event], pulsetime: float = 5) -> List[Event]:
    ...
    For more details on flooding, see this issue:
     - https://github.com/TimeBench/timebench/issues/124
    """
    # Originally written in aw-research: https://github.com/TimeBench/aw-analysis/blob/7da1f2cd8552f866f643501de633d74cdecab168/aw_analysis/flood.py
    # NOTE: This algorithm has a lot of smaller details that need to be
    #       carefully considered by anyone wishing to edit it, see:
    #        - https://github.com/TimeBench/aw-core/pull/73
